...
class TypistModel(aFile: File) { // : Model() {
    ...
    private val typesetChars: List<Char> = emptyList()
...
//        val imageSize = Constants.ImageFontSize + Constants.ImageMargin * 2
...
//                val anElement = Element(anImage, x, y).apply {
//                    normalize(this@TypistModel.minLuminance, this@TypistModel.maxLuminance)
//                }
...
//
//        if (checkFont()) {
//            println("[model] Font file '${Constants.FontName}' exists.")
//        } else {
//            println("[model] Font file '${Constants.FontName}' doesn't exist.")
//        }
//
...
//        return Constants.FontName in fonts
//    }
...
//        try {
//            val font = Font.createFont(Font.TRUETYPE_FONT, File(Constants.FontFilePath))
...
//        val fontSize = Constants.ImageFontSize
//        val margin = Constants.ImageMargin
...
//        val fileString = currentDirectory + File.separator + Constants.TypistArtFileName + Constants.HtmlExtension
...
//
//        val tasks = pictureElements.map { element ->
...
//
//            val results = futureResults.map { future ->
//                try {
//                    future.get()
...
//        val from = max(0, index - Constants.NumberOfCandidates / 2)
//        val to = min(this.typesetElements.size, from + Constants.NumberOfCandidates)
...
//
//        return if (parsed in Constants.MinimumTypingLength..Constants.MaximumTypingLength) {
